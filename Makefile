...
test_env.container_prepare:
	apk add -U curl git build-base jq openssh
...
test_env.container_upload:
	...
	codecovcli -u ${CODECOV_URL} --verbose do-upload --flag latest-uploader-overall
	codecovcli -u ${CODECOV_URL} --verbose do-upload --flag unit --file unit.coverage.xml
	codecovcli -u ${CODECOV_URL} --verbose do-upload --report-type test_results --flag unit --file unit.junit.xml --disable-search --plugin None
	codecovcli -u ${CODECOV_URL} --verbose do-upload --flag integration --file integration.coverage.xml
	codecovcli -u ${CODECOV_URL} --verbose do-upload --report-type test_results --flag integration --file integration.junit.xml --disable-search --plugin None
